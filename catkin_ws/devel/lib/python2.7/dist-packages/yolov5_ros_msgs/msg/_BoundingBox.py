...
class BoundingBox(genpy.Message):
  _md5sum = "0ad4b46a52e807aba32a94d1332666c7"
...
int64 id
"""
  __slots__ = ['probability','xmin','ymin','xmax','ymax','num','Class','id']
  _slot_types = ['float64','int64','int64','int64','int64','int16','string','int64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       probability,xmin,ymin,xmax,ymax,num,Class,id
